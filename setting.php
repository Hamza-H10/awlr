...
$details='';
$details=array('name'=> $_POST['name'],'name_tag'=> $_POST['name_tag'], 'gstin'=>$_POST['gstin'],'cin'=>$_POST['cin'],'gst_rate'=>$_POST['gst_rate'],'address1'=>$_POST['address1'],'address2'=>$_POST['address2'],'address3'=>$_POST['address3'],'address4'=>$_POST['address4'],'contact'=>$_POST['contact'],'landline'=>$_POST['landline'],'email'=>$_POST['email']);
$detailss=serialize($details);

	$stmt = $db->prepare("UPDATE tbl_setting  SET details=:details,payment_details=:payment_details where id=1");
			$stmt->bindParam(":details",$detailss);
...
<div class="form-group" style="margin-top:5px">
        ...
        <div class="form-group" style="margin-top:5px">
        <input  name="name_tag" class="form-control titleModal" placeholder="Name Tag (Optional)" value="<?=$details['name_tag']?>"   type="text" title="Name Tag (Optional)" data-placement="left">
        ...
        <input id="textValue" name="gstin" class="form-control titleModal" value="<?=$details['gstin']?>" placeholder="GSTIN"  required="required" type="text" title="Gstin" data-placement="left">
         ...
         <div class="form-group" >
        <input id="textValue" name="cin" class="form-control titleModal" value="<?=$details['cin']?>" placeholder="CIN (Optional)"   type="text" title="CIN" data-placement="left">
        ...
        <select id="select_gst_rate" name="gst_rate[]" class="form-control" onchange="calculateSum();">
     ...
     <option <?php if($details['gst_rate']['0']=='9'){echo 'selected="selected"';} ?>>9</option>
      <option <?php if($details['gst_rate']['0']=='14'){echo 'selected="selected"';} ?>>14</option>
       ...
       <br />
        ...
        <div class="form-group" style="margin-top:5px">
        <input id="textValue" name="address4" class="form-control" placeholder="Address Line 4"   type="text" value="<?=$details['address4']?>">
       
        </div>
        <label>Contact</label>
         <div class="form-group" style="margin-top:5px">
        <input id="textValue" name="contact" class="form-control" placeholder="Mobile No."  type="text" value="<?=$details['contact']?>">
       
        </div>
        
        <div class="form-group" style="margin-top:5px">
        <input id="textValue" name="landline" class="form-control" placeholder="Landline No."  type="text" value="<?=$details['landline']?>">
