...
<div class="ui selection dropdown">
  ...
  <div class="menu">
    <div class="item" data-value="11">Slave 1 - Channel 1</div>
    <div class="item" data-value="12">Slave 1 - Channel 2</div>
    <div class="item" data-value="13">Slave 1 - Channel 3</div>
    <div class="divider"></div>
    <div class="item" data-value="21">Slave 2 - Channel 4</div>
    <div class="item" data-value="22">Slave 2 - Channel 5</div>
    <div class="item" data-value="23">Slave 2 - Channel 6</div>
    <div class="divider"></div>
    <div class="item" data-value="31">Slave 3 - Channel 7</div>
    <div class="item" data-value="32">Slave 3 - Channel 8</div>
    <div class="item" data-value="33">Slave 3 - Channel 9</div>
    <div class="item" data-value="34">Slave 3 - Channel 10</div>
  </div>
</div>
...
<a name="table1_user_form_target"></a>
    ...
    <div class="ui horizontal divider header">Piezo Data</div>
  <!-- DATA LIST -->
  ...
  <script>
    var table1= new Tabulation({
            apiUrl: "<?=$app_root?>/api/?function=vw_list&slave_no=1&channel_no=1&pgno=",
    ...
    $(function() {
        ...
        //table1.init();
        table1.loadPage(1, true, "<?=$app_root?>/api/?function=vw_list&slave_no=1&channel_no=1&pgno=");

    });

    $(".dropdown").dropdown({
        onChange: function (val) {
          var slave_no = Math.floor(val/10);
          var channel_no = 3 * (slave_no - 1) + (val % 10);
    ...
    function table1_generate(myObj, self_prefix) {
        ...
        var table_output = "<table class='ui celled table'><thead><tr>" + 
                    ...
                    "<th class='right aligned'>Engg. Unit (Ksc)</th>" +
