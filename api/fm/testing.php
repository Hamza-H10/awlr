    ...
    <script>
        function createChart(data) {
            ...
            const config = {
                type: 'line',
                data: {
                    labels: aValues, //In this case, the labels are the values of the  A  column in the data.
                    datasets: [{ //datasets property specifies the data points for the chart.
        ...
        // Test Data
        const testData = [{
                'Cumulative Negative Depth': -18.0,
                'A': 1.63
            },
            {
                'Cumulative Negative Depth': -36.0,
                'A': -0.74
            },
            {
                'Cumulative Negative Depth': -60.0,
                'A': -2.07
            },
            {
                'Cumulative Negative Depth': -90.0,
                'A': -2.32
            },
            {
                'Cumulative Negative Depth': -126.0,
                'A': 2.23
            },
            {
                'Cumulative Negative Depth': -168.0,
                'A': -1.78
            },
            {
                'Cumulative Negative Depth': -216.0,
                'A': -1.93
            },
            {
                'Cumulative Negative Depth': -222.0,
                'A': 7.05
            },
